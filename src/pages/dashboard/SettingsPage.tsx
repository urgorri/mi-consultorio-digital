          ...
          <TabsContent value="perfil" className="mt-4 space-y-4">
            <div className="bg-card rounded-xl border border-border p-5 space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label>Correo</Label>
                  <Input defaultValue="dra.garcia@email.com" />
                </div>
                <div className="space-y-2">
                  <Label>Teléfono</Label>
                  <Input defaultValue="+52 55 9876 5432" />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="border border-border rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-foreground">Consultorio Centro</p>
                      <p className="text-sm text-muted-foreground">Av. Reforma 123, Col. Centro, CDMX</p>
                    </div>
                ...
                <div className="border border-border rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-foreground">Consultorio Norte</p>
                      <p className="text-sm text-muted-foreground">Blvd. Ávila Camacho 456, Polanco, CDMX</p>
                    </div>
                    <Button variant="ghost" size="sm">Editar</Button>
                  </div>
                </div>
