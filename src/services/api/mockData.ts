...
export const mockConsultations: Consultation[] = [
  {
    ...
    diagnoses: [{ code: "I10", name: "Hipertensión esencial (primaria)" }],
  ...
  },
  {
    ...
    diagnoses: [{ code: "Z01.7", name: "Examen de laboratorio" }],
  ...
  },
  {
    ...
    diagnoses: [{ code: "E11", name: "Diabetes mellitus tipo 2" }],
  ...
  },
  {
    ...
    diagnoses: [{ code: "J45.0", name: "Asma predominantemente alérgica" }],
...
export const mockDiagnoses: Diagnosis[] = [
  { code: "A09", name: "Diarrea y gastroenteritis de presunto origen infeccioso", category: "Infecciosas" },
  { code: "B34.9", name: "Infección viral, no especificada", category: "Infecciosas" },
  { code: "E11", name: "Diabetes mellitus tipo 2", category: "Endocrinas" },
  { code: "E78.0", name: "Hipercolesterolemia pura", category: "Endocrinas" },
  { code: "F32.9", name: "Episodio depresivo, no especificado", category: "Mentales" },
  { code: "F41.1", name: "Trastorno de ansiedad generalizada", category: "Mentales" },
  { code: "G43.9", name: "Migraña, no especificada", category: "Neurológicas" },
  { code: "H10.9", name: "Conjuntivitis, no especificada", category: "Oftalmológicas" },
  { code: "I10", name: "Hipertensión esencial (primaria)", category: "Circulatorias" },
  { code: "J06.9", name: "Infección aguda de las vías respiratorias superiores, no especificada", category: "Respiratorias" },
  { code: "J20.9", name: "Bronquitis aguda, no especificada", category: "Respiratorias" },
  { code: "J45.0", name: "Asma predominantemente alérgica", category: "Respiratorias" },
  { code: "K21.0", name: "Enfermedad por reflujo gastroesofágico con esofagitis", category: "Digestivas" },
  { code: "K29.7", name: "Gastritis, no especificada", category: "Digestivas" },
  { code: "K30", name: "Dispepsia funcional", category: "Digestivas" },
  { code: "L30.9", name: "Dermatitis, no especificada", category: "Dermatológicas" },
  { code: "M54.5", name: "Dolor en la parte baja de la espalda", category: "Musculoesqueléticas" },
  { code: "N39.0", name: "Infección de vías urinarias, sitio no especificado", category: "Genitourinarias" },
  { code: "R50.9", name: "Fiebre, no especificada", category: "Síntomas" },
  { code: "R51", name: "Cefalea", category: "Síntomas" },
  { code: "Z00.0", name: "Examen médico general", category: "Factores" },
  { code: "Z01.7", name: "Examen de laboratorio", category: "Factores" },
];
